...
export function DebtsCard({
  ...
  return (
    <View className="bg-white dark:bg-zinc-900 rounded-3xl border border-slate-100 dark:border-zinc-800 p-4 flex-1 justify-center">
      {/* Top section: Net Debt */}
      ...
      {/* Bottom section: Receivables and Payables side by side */}
      <View className="flex-row items-center divide-x divide-slate-100 dark:divide-zinc-800">
        <View className="flex-1 items-center px-1">
          <Text variant="small" className="text-center mb-1 leading-tight">Мне должен</Text>
          <Text className="text-base font-semibold text-green-600">
            {fmt(receivables, isDataHidden)}
          </Text>
        </View>
        <View className="flex-1 items-center px-1">
          <Text variant="small" className="text-center mb-1 leading-tight">Я должен</Text>
